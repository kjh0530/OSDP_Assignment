...
public class Quiz7_12 {
    private String name; // Word2Quiz 프로그램의 이름
	private Scanner scanner = new Scanner(System.in);
	private Vector<Word2> v;

	public Quiz7_12(String name) {
		this.name = name;
		v = new Vector<Word2>();
	...
	public void run() {
		...
		while(true) {
			...
			try {
				...
				switch(menu) {
					case 1: Word2Quiz(); break;					
					case 2: insertWord2s(); break;
	...
	private void insertWord2s() {
		System.out.println("영어 단어에 그만을 입력하면 입력을 종료합니다.");
		while(true) {
			System.out.print("영어 한글 입력 >> ");
			String engWord2 = scanner.next(); // 영어 단어 읽기
			if(engWord2.equals("그만"))
				break;
			
			String korWord2 = scanner.next(); // 한글 단어 읽기
			v.add(new Word2(engWord2, korWord2));
		}		
	}
	...
	public static void main(String[] args) {
		Quiz7_12 quiz = new Quiz7_12("명품영어");
		quiz.run();
	}
}
